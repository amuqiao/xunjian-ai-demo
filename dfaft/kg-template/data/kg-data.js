 ...
 * ═══════════════════════════════════════════════════════════════════
 * 接入自己的业务数据时，这里承载 canonical KG.source。
 * 类型 label、指标 label/unit 等跟数据同源的命名也放在这里；
 * 视图文案、单位和展示上限放在 kg-config.js。
 ...
 *   4. children 想套几层就套几层，超出 treeLevels 后会沿用最后一级类型。
 *
