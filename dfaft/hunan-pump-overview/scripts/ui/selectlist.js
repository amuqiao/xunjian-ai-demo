...
// 不新开一个平行组件。
//
// 命名空间纪律：选择器统一用 data-select + data-select-id，绝不使用 HunanContract.ZONE_PIN_ATTR / SITE_PIN_ATTR
// 对应的那个属性名（3D 区域热点标签独占，见 scripts/map3d/contract.js 的 assertPinNamespace）。
//
...
(function () {
  ...
  var STATUSES = window.HunanContract.STATUSES;
