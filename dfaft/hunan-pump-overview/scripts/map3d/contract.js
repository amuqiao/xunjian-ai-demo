...
// 本文件与 poc/hunan-inspection-overview/scripts/map3d/contract.js 是逐字节相同的独立
// 副本（除本段 POC 名称注释）——两块大屏刻意互不耦合，各持完整契约副本，运行时零
// 共享，不要把两者合并成一份"共享契约模块"再互相 import，那会重新引入耦合。
//
