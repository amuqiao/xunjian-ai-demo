/*
 * data.js — 全部演示数据(冻结样例)。挂到 window.DEMO_DATA。
 * 场景 JS 一律从此处取数,不得内联硬编码业务数据。
 * 图片路径:相对 assets/poc/prototype-v2/index.html,统一走 ../../data/。
 */
(function () {
  "use strict";
  ...
  window.DEMO_DATA = {
    ...
    site: {
      name: "长郴-湘潭站",
      subtitle: "巡检质量智能分析 · 任务批次 XJ-20260721-A",
    ...
    // 站场 SVG 图形(供 overview 场景渲染)
    siteMap: {
      viewBox: "0 0 900 560",
      route: "M105 338 C210 248, 260 170, 390 190 C520 210, 552 314, 670 270 C740 244, 792 186, 832 120",
      riskDot: { area: "metering", cx: 386, cy: 222, r: 13 },
      shapes: [
        { area: "valve", points: "95,330 205,270 250,352 154,430", label: "阀组区", lx: 122, ly: 384 },
        { area: "metering", points: "292,160 432,154 480,262 355,318 264,250", label: "计量区", lx: 332, ly: 236 },
        { area: "pump", points: "510,262 642,236 700,326 590,402 486,346", label: "泵区", lx: 568, ly: 336 },
        { area: "control", points: "690,116 815,88 850,180 744,224", label: "站控室", lx: 730, ly: 158 },
        { area: "plc", points: "712,268 820,256 846,352 746,392", label: "PLC机房", lx: 742, ly: 330 },
        { area: "ups", points: "186,122 270,92 318,150 248,214", label: "UPS室", lx: 214, ly: 164 },
      ],
    },

    // 精选巡检项表格
    inspectionRows: [
      { item: "pressure", no: 63, area: "计量区", device: "污油罐", check: "压力", result: "0.06", hot: false },
      { item: "dp", no: 73, area: "计量区", device: "过滤器", check: "差压", result: "正常", hot: true },
      { item: "panel", no: 76, area: "计量区", device: "电动执行机构", check: "显示面板", result: "正常", hot: false },
      { item: "indicator", no: 77, area: "计量区", device: "电动执行机构", check: "指示灯", result: "正常", hot: false },
      { item: "level", no: 97, area: "计量区", device: "污油罐", check: "液位", result: "329mm", hot: false },
      { item: "plc", no: 288, area: "PLC机房", device: "PLC机柜", check: "POWER灯", result: "正常", hot: false },
    ],
    ...
    trendSeries: {
      ...
      levelStable: {
        ...
        quality: "12/12", window: null,
        summary: "液位在 320mm 附近波动,不进入本轮复检主线。",
        points: [
      ...
      pumpStable: {
        ...
        points: [
          ["07-18 04:00", 84], ["07-18 12:00", 85], ["07-18 20:00", 83],
          ["07-19 04:00", 84], ["07-19 12:00", 86], ["07-19 20:00", 85],
          ["07-20 04:00", 84], ["07-20 12:00", 85], ["07-20 20:00", 86], ["07-21 04:00", 85],
        ],
      },
      plcHealth: {
        title: "PLC 通讯健康度 · 抽查",
        ...
        points: [
          ["07-18 04:00", 96], ["07-18 12:00", 95], ["07-18 20:00", 96],
          ["07-19 04:00", 97], ["07-19 12:00", 96], ["07-19 20:00", 95],
          ["07-20 04:00", 96], ["07-20 12:00", 96], ["07-20 20:00", 97], ["07-21 04:00", 96],
        ],
      },
      videoQuality: {
        title: "站控室监控质量",
        ...
        points: [
          ["07-18 04:00", 90], ["07-18 12:00", 88], ["07-18 20:00", 89],
          ["07-19 04:00", 91], ["07-19 12:00", 87], ["07-19 20:00", 89],
          ["07-20 04:00", 90], ["07-20 12:00", 88], ["07-20 20:00", 91], ["07-21 04:00", 90],
        ],
      },
      valveStable: {
        title: "阀组区状态 · 平稳",
        ...
        points: [
          ["07-18 04:00", 88], ["07-18 12:00", 87], ["07-18 20:00", 89],
          ["07-19 04:00", 88], ["07-19 12:00", 90], ["07-19 20:00", 89],
          ["07-20 04:00", 88], ["07-20 12:00", 87], ["07-20 20:00", 89], ["07-21 04:00", 88],
        ],
      },
      upsStable: {
        title: "UPS 室参数 · 平稳",
        ...
        points: [
          ["07-18 04:00", 93], ["07-18 12:00", 94], ["07-18 20:00", 93],
          ["07-19 04:00", 94], ["07-19 12:00", 95], ["07-19 20:00", 94],
          ["07-20 04:00", 93], ["07-20 12:00", 94], ["07-20 20:00", 95], ["07-21 04:00", 94],
        ],
      },
    },
    ...
    itemDetails: {
      dp: {
        ...
        tags: ["第73项", "差压", "趋势异常", "主证据"], flow: "trend", trendKey: "filterDp", image: "current",
      },
      pressure: {
        evidence: "已选中污油罐压力项。当前作为正常对照数据,帮助说明系统不是全量报错。",
        tags: ["压力", "正常对照", "0.06", "辅助项"], flow: "analysis", trendKey: "pressureStable", image: "current",
      },
      panel: {
        evidence: "已选中电动执行机构显示面板。可切换现场帧展示视觉辅助证据,但不替代人工确认。",
        tags: ["执行机构", "显示面板", "视觉辅助"], flow: "visual", trendKey: "filterDp", image: "current",
      },
      indicator: {
        evidence: "已选中电动执行机构指示灯。建议补拍指示灯、阀位和远传状态,作为复检辅助证据。",
        tags: ["指示灯", "补拍建议", "视觉证据"], flow: "visual", trendKey: "filterDp", image: "current",
      },
      level: {
        evidence: "已选中污油罐液位项。液位示值作为辅助数据,不进入本轮高优先级复检主线。",
        tags: ["液位", "329mm", "辅助数据"], flow: "analysis", trendKey: "levelStable", image: "current",
      },
      plc: {
        evidence: "已选中 PLC 机柜 POWER 灯项。右侧关键帧切换到 PLC 机房,核验灯态识别结果。",
        tags: ["PLC", "POWER灯", "灯态识别"], flow: "visual", trendKey: "plcHealth", image: "plc",
      },
    },
    ...
    // 复检异常摘要
    recheckSummary: {
      trigger: "差压趋势接近 0.1MPa,且表单结果仍填写“正常”。",
      relation: "计量区 / 过滤器 / 差压。",
      source: "巡检记录第 73 项 + 差压趋势候选文件。",
    },
    ...
    reportVersion: "任务批次 XJ-20260721-A / 巡检质检规则库 / 交接班归档模板",
    ...
    railSteps: [
      { scene: "overview", label: "态势总览" },
      { scene: "analysis", label: "巡检分析" },
      { scene: "recheck", label: "复检确认" },
      { scene: "report", label: "报告归档" },
    ],
    // 闭环状态步骤(右侧/报告页用)
    stepOrder: ["analysis", "evidence", "recheck", "confirm", "report"],
    stepLabels: {
      analysis: "AI 发现疑点",
      evidence: "知识依据命中",
      recheck: "生成复检清单",
