...
本文不再做技术选型比较。通用选型方法保留在 [通用 AI 赋能演示 demo 技术实现选型方案.md](通用%20AI%20赋能演示%20demo%20技术实现选型方案.md)；本项目从这里开始只维护固定主线、可枚举支线和明确不做项。
...
| 通用 AI demo 技术选型方法 | [通用 AI 赋能演示 demo 技术实现选型方案.md](通用%20AI%20赋能演示%20demo%20技术实现选型方案.md) |
