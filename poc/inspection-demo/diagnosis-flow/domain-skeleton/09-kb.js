  ...
  var DATA = {
    ...
    documents: [
      ...
      },
      {
        id: "DOC-XT-MAINT",
        categoryId: "cat-card",
        title: "湘潭站 P-3 泵大修前巡检提醒",
        type: "维检修提醒",
        summary: "记录湘潭站泵棚区 P-3 泵 2026年7月28日计划大修前的巡检重点。",
        source: "湘潭站近期维检修作业提醒（演示数据）",
        updatedAt: "2026-08-16",
        body: [
          "湘潭站泵棚区计划于 2026年7月28日开展 P-3 泵大修作业，系统应在该区域巡检时提示近期维检修作业信息。",
          "大修前巡检应加强泄漏检查、出口管线压力检查、温度检查、运行情况确认、油位检查和设备外观检查。",
          "巡检人员应补充大修前基准照片、复测数据和运行工况说明；若发现压力、温度、油位或外观状态异常，应形成问题记录。"
        ]
      }
    ],
    ...
    qaPresets: [
      ...
      {
        id: "QA-XT-3",
        question: "P-3 泵大修前巡检要重点看什么？",
        answer: "P-3 泵计划于 2026年7月28日开展大修，巡检应重点加强泄漏、出口管线压力、温度、运行情况、油位和外观检查，并补充大修前基准照片、复测数据和工况说明。",
