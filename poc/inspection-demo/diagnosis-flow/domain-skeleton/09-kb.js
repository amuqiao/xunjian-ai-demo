  ...
  var DATA = {
    ...
    documents: [
      ...
      },
      {
        id: "DOC-XT-ISSUE",
        categoryId: "cat-case",
        title: "湘潭站配电间 P6 泵高压柜巡检问题",
        type: "巡检案例",
        summary: "记录湘潭站配电间 P6 泵高压柜表计及测显装置无显示、控制回路断线报警和接线松动处置过程。",
        source: "湘潭站巡检问题记录（演示数据）",
        updatedAt: "2026-08-16",
        body: [
          "4月24日，长郴管道湘潭站生产运维人员在配电间巡检过程中发现 P6 泵高压柜开关柜上表计及测显装置无显示。",
          "经排查，高压柜内二次回路控制电源空开跳闸，微机综保系统报控制回路断线报警动作，需要将该区域列入近期重点问题提醒。",
          "处置结果为排查发现操作柱接线松动，完成紧固和功能恢复；后续巡检应重点关注柜内控制电源、综保报警、测显装置和操作柱接线状态。"
        ]
      },
      {
        id: "DOC-XT-INTERLOCK",
        categoryId: "cat-card",
        title: "湘潭站 P-3 泵 PT6903B 安全联锁提醒",
        type: "联锁阈值",
        summary: "记录湘潭站泵棚区 P-3 泵出口管线压力变送器 PT6903B 的报警阈值和巡检提醒口径。",
        source: "湘潭站泵棚区联锁仪表台账（演示数据）",
        updatedAt: "2026-08-16",
        body: [
          "湘潭站泵棚区 P-3 泵出口管线压力变送器位号为 PT6903B，属于巡检时需要重点核对的安全联锁相关仪表。",
          "系统提醒该测点高报警值为 9.0MPa，高高报警值为 9.8MPa；巡检发现压力接近阈值、波动异常或现场读数与系统读数不一致时，应升级复核。",
          "巡检人员应同时查看压力趋势、上下游工况、现场泄漏迹象和仪表引压管状态，避免只依据单点瞬时值判断。"
        ]
      },
      {
        id: "DOC-XT-MAINT",
        categoryId: "cat-card",
        title: "湘潭站 P-3 泵大修后巡检提醒",
        type: "维检修提醒",
        summary: "记录湘潭站泵棚区 P-3 泵 2026年7月28日大修作业后的巡检重点。",
        source: "湘潭站近期维检修作业提醒（演示数据）",
        updatedAt: "2026-08-16",
        body: [
          "湘潭站泵棚区已于 2026年7月28日完成 P-3 泵大修作业，系统应在该区域巡检时提示近期维检修作业信息。",
          "大修后巡检应加强泄漏检查、出口管线压力检查、温度检查、运行情况确认、油位检查和设备外观检查。",
          "若发现压力、温度、油位或外观状态与大修后基准不一致，应补充现场照片、复测数据和运行工况说明，并形成问题记录。"
        ]
      }
    ],
    ...
    qaPresets: [
      ...
      {
        id: "QA-XT-1",
        question: "湘潭站近期有哪些典型巡检问题？",
        answer: "湘潭站配电间近期典型问题为 P6 泵高压柜表计及测显装置无显示，排查发现控制电源空开跳闸、综保报控制回路断线，最终确认为操作柱接线松动并已修复。",
        citations: [{ docId: "DOC-XT-ISSUE", hintChunks: [0, 1, 2] }]
      },
      {
        id: "QA-XT-2",
        question: "PT6903B 的安全联锁报警值是多少？",
        answer: "湘潭站泵棚区 P-3 泵出口管线压力变送器 PT6903B 的高报警值为 9.0MPa，高高报警值为 9.8MPa，接近阈值或读数不一致时应升级复核。",
        citations: [{ docId: "DOC-XT-INTERLOCK", hintChunks: [0, 1] }]
      },
      {
        id: "QA-XT-3",
        question: "P-3 泵大修后巡检要重点看什么？",
        answer: "P-3 泵已于 2026年7月28日完成大修，巡检应重点加强泄漏、出口管线压力、温度、运行情况、油位和外观检查；发现与大修后基准不一致时应补充照片、复测数据和工况说明。",
        citations: [{ docId: "DOC-XT-MAINT", hintChunks: [0, 1, 2] }]
      }
    ],
