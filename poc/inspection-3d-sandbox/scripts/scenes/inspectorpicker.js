...
// 不可再点：点一个可选行会直接把该姓名追加进当前任务、并关闭弹层——这与
// scenes/areapicker.js「选中即生效」是同一种交互范式，不为"添加人员"单独发明一套
// "先选中、再点确认"的两步流程。
//
...
//
// 交互点没有 data-action：boot.js 按处理 areapicker.js 的 [data-area-id] 同样的方式，
// 直接用属性选择器 [data-inspector-name] 做事件委托，不在这里发明一套 data-action 名字。
(function () {
  "use strict";
