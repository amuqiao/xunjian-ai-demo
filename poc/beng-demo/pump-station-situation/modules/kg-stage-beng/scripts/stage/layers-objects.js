...
(function () {
  ...
  function buildCore(root) {
    ...
    var title = hub ? hub.name : '十项运维主题';
    // 两行排版：按数据字符串动态切分，不硬编码文案
  ...
  function buildTopStage(root) {
    ...
    var badges = [
      { x: -80, y: -160, text: '标准体系', action: 'tech-attack' },
      { x: 0, y: -160, text: '作业管控', action: 'platform' },
      { x: 80, y: -160, text: '故障复盘', action: 'talent' }
    ];
