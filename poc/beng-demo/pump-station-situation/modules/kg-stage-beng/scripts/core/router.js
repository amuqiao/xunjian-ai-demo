...
(function(){
  ...
  function updateNavActive(parsed){
    ...
    for(var i = 0; i < btns.length; i++){
      ...
      // 同一目标页可能有多个带不同 data-view 的导航按钮（如"三类应用场景"/"十项运维主题"
      ...
      // 命中就恒亮，#/graph?view=task 时「十项运维主题」和「图谱看板」会同时点亮。
      if(isMatch){
