...
(function () {
  ...
  // L2：七类知识分类环绕角度，0° = 正前方 +Y，顺时针增大（对齐参考图标定结果）。
  // D4 恢复参考标定的 25°（Fix-4 之前曾临时改成 35° 来避让 --y:340 的
  // 右侧应用场景悬浮牌，那其实是下面 DOMAIN_RADIUS_KX/KY 把球环压成
  ...
  // 3-B：D5 从 62 调到 70——应用场景组 --y 推到 460 之后，D5
  // 原本落点与右侧应用场景悬浮牌相交（断言 30 实测 FAIL）。对 45~75 度
  ...
  // L3：三类应用场景左中右分布（长郴管道 / 泵机组设备 / 站场运维班组）
  ...
  /* ============================================================
   * 四、L2 七类知识分类球：球体 + 地面投影两个兄弟元素，外加一枚远景青雾
   * ========================================================== */
  ...
  /* ============================================================
   * 五、L3 三类应用场景全息投影：每组 5 个兄弟元素（光锥×2 + 地面光环×2 + 悬浮牌）
   * ========================================================== */
